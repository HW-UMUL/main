...
const submitForm = async () => {
  ...
  try {
    axios.put(`http://localhost:8080/api/wiki/update/${route.params.id}`, data, { headers })
    .then(res => {
    ...
    <form @submit.prevent="submitForm">
      <table border="1" width="90%" height="700">
        <tr><td><input type="text" v-model="formData.title" placeholder="title" style="padding-left: 20px;
          padding-top: 10px; padding-bottom: 10px; width: 100%"></td></tr>
        <tr><td><input type="text" v-model="formData.category" placeholder="category" style="padding-left: 20px;
          padding-top: 10px; padding-bottom: 10px; "></td></tr>
        <tr><td><textarea placeholder="content" v-model="formData.content" rows="25" cols="130" style="padding-left: 20px;
          padding-top: 10px; padding-bottom: 10px;"></textarea></td></tr>
        <tr><td><input type="text" v-model="formData.tag" placeholder="tag" style="padding-left: 20px;
              padding-top: 10px; padding-bottom: 10px; width: 100%"></td></tr>
        <tr align="center"><td>
          ...
          border-style: solid;
          font-size: 15px;" type="submit">작성</button>
          <button style="background-color: #905DFF;
          border: none;
          color: white;
          padding: 7px 15px;
          ...
          display: inline-block;
          border-style: solid;
          font-size: 15px;" @click="location.href='this.$router.go(-1)'">취소</button></td></tr>

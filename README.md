...
### ⛵ 이경민
- **Project Manager**
     - 일정 관리, 기획 문서 정리, 일일 및 멘토링 회고 정리, 의견 수립 및 전달, README-Wiki 작성
- **Backend**
     - Post-Wiki 검색, 검색 로그 기록 및 출력
- **Frontend**
     - 검색창, 
...
애자일 방법론에 따른 3단계  
(개발 과정에서 기존에 세웠던 애자일 일정과 정확하게 일치하지 않았지만 크게 3단계로 분류할 수 있다. <- 이부분은 README 에는 뺴고 참고용)  
1. 기본적인 기능 개발

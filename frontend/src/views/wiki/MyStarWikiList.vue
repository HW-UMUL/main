...
const listCunt = ref('20') // 한 페이지에 노출될 게시글 개수
...
const getList = () => {
  axios
    .get(`http://${serverAddress}/api/wikistar/read/my`, {
      headers: {
    ...
    >
      <tr>
        ...
        <td
          ...
          align="center"
        >
          {{ item.wiki.user.username }}
        </td>
        <td
          width="10%"
          align="center"
        >
          {{ item.wiki.date.substring(0, 10) }}
        </td>
      </tr>
      <tr>
        <td colspan="3"><hr /></td>
